...
describe('Funcionamiento del boton iniciar sesion', () => {
  it('passes', () => {
    cy.visit('http://localhost:5272/')
    cy.xpath('/html/body/main/nav/div/div[1]/div/a[6]').click()
    cy.wait(1000)
...
describe('Funcionamiento del modal crear cita', () => {
  it('passes', () => {
    cy.visit('http://localhost:5272/Recepcionista')
    cy.xpath('/html/body/main/div/div[2]/div/div/div[1]/div[1]/div[1]/button/span').click()
    cy.wait(500)
    cy.xpath('//*[@id="VeterinarioID"]').select('Carlos Ruiz Delgado')
    cy.wait(500)
    cy.xpath('//*[@id="MascotaID"]').select('Bolt')
    cy.wait(500)
    cy.xpath('//*[@id="TipoCitaID"]').select('Chequeo Otológico')
    cy.wait(500)
    cy.xpath('//*[@id="fechaCitaInput"]').type('2025-12-15')
    cy.wait(500)
    cy.xpath('//*[@id="horaCitaInput"]').type('10:30')
    cy.wait(500)
    cy.xpath('//*[@id="ImporteAdicional"]').clear().type('199.99')
    cy.wait(500)
    cy.xpath('/html/body/main/div/div[2]/div/div/div[1]/div[2]/div/form/div[2]/button[2]').click()
    cy.wait(1000)
  })
})
...
describe('Validacion de salida del modal', () => {
  it('passes', () => {
    ...
    cy.xpath('/html/body/main/div/div[2]/div/div/div[1]/div[1]/div[1]/button/span').click()
    cy.wait(500)
    cy.xpath('/html/body/main/div/div[2]/div/div/div[1]/div[2]/div/form/div[2]/button[1]').click()
    cy.wait(1000)
  })
})

describe('Carga del apartado calendario', () => {
  it('passes', () => {
    cy.visit('http://localhost:5272/Recepcionista/Calendario')
    cy.wait(1000)
  })
})

describe('Carga del apartado cita en calendario', () => {
  it('passes', () => {
    cy.visit('http://localhost:5272/Recepcionista/Calendario')
    cy.wait(500)
    cy.xpath('/html/body/main/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]/div').click()
    cy.wait(1000)
  })
})

describe('Cambio de semana en calendario', () => {
  it('passes', () => {
    cy.visit('http://localhost:5272/Recepcionista/Calendario')
    cy.wait(500)
    cy.xpath('/html/body/main/div[1]/div[2]/div[1]/div[1]/div[2]/a[3]').click()
    cy.wait(500)
    cy.xpath('/html/body/main/div[1]/div[2]/div[1]/div[1]/div[2]/a[1]').click()
    cy.wait(1000)
  })
})

describe('Boton hoy en calendario', () => {
  it('passes', () => {
    cy.visit('http://localhost:5272/Recepcionista/Calendario')
    cy.xpath('/html/body/main/div[1]/div[2]/div[1]/div[1]/div[2]/a[3]').click()
    cy.wait(500)
    cy.xpath('/html/body/main/div[1]/div[2]/div[1]/div[1]/div[2]/a[2]').click()
    cy.wait(1000)
  })
})

describe('Carga del apartado Inventario', () => {
  it('passes', () => {
    cy.visit('http://localhost:5272/Recepcionista/Inventario')
    cy.wait(1000)
  })
})